...
Welcome to Hive.blog!  This agreement (the “Agreement”) between you and
Hive.blog, (“we”, “us”, “our”) sets out your rights to access
and use of hive.blog and any other products or services provided by us (the
...
hive.blog. Your continued use of the Service will confirm your acceptance of
the changes.
...
the Hive blockchain or our licensors, which we call “Hive.blog Content.”
Hive.blog Content is protected by intellectual property laws, including copyright
...
rights to use Hive.blog Content.

You are granted a limited, non-exclusive, non-transferable, and
non-sublicensable license to access and use the Service and Hive.blog Content for
...
“Hive.blog,”, the Hive.blog logo and any other product or service names, logos,
slogans that may appear on the Service are trademarks of Hive.blog, and,
...
look and feel of hive.blog and the Service is protected by copyright ©
Hive.blog, All rights reserved. You may not duplicate, copy, or reuse any
portion of the HTML/CSS, Javascript, or visual design elements or concepts
without express written permission.

We encourage third-party dapp developers building on top of the Hive
blockchain to reach out to legal@hive.blog for all branding and licensing
questions.
...
## 6. Agreement to Hold Hive.blog, Harmless

6.1. You agree to hold harmless Hive.blog, (and each of our officers,
...
of the Service, you must create a Hive blockchain account (“Account”).
...
Service or accessing Hive.blog Content, you acknowledge these inherent risks.

## 9. The Services

9.1. As described in more detail below, the Services, among other things,
provide software that facilitates the submission of Hive blockchain
transaction data to the Hive blockchain without requiring you to access the
Hive blockchain command line interface.
...
connection with the Account to authorize the transfer of HIVE and Hive
...
HIVE, Hive Power and Hive Dollars associated with your Account.
...
operated by us. The Hive blockchain is operated by a decentralized network of
independent third parties. We have no control over the Hive blockchain and
therefore cannot and will not ensure that any transaction details you submit
via the Services will be confirmed on the Hive blockchain. You acknowledge and
agree that the transaction details you submit via the Services may not be
completed, or may be substantially delayed, by the Hive blockchain. You may
use the Services to submit these details to the Hive blockchain.
...
ownership record maintained on the Hive blockchain. The Service does not
store, send, or receive HIVE, Hive Dollars, or Hive Power. Any transfer of
title that might occur in any HIVE, Hive Dollars or Hive Power occurs on the
Hive blockchain and not within the Services. We do not guarantee that the
Service can affect the transfer of title or right in any HIVE, Hive Dollars
or Hive Power.
...
make in connection with any Hive blockchain transaction initiated via the
...
determining whether taxes apply to your Hive blockchain transactions or for
collecting, reporting, withholding, or remitting any taxes arising from any
Hive blockchain transactions.
...
Services, you will be may not be able to access HIVE, Hive Dollars and Hive
...
hive.blog account and all related information and files in such without cost
...
you access to the Hive blockchain via the command line API or third party
...
To the fullest extent permitted by applicable law, the Service and the Hive.blog
...
the Service and the Hive.blog Content: (a) will be secure or available at any
...
other harmful components. Your use of the Service and Hive.blog Content is solely
...
To the fullest extent permitted by applicable law, in no event shall Hive.blog,
or the any related party to Hive.blog, that includes but is not
...
connected with, the use of, or inability to use, the Service or the Hive.blog
Content. To the fullest extent permitted by applicable law, in no event shall
the aggregate liability of Hive.blog, or any related party, whether in
...
arbitrate certain disputes with Hive.blog, and limits the way you can seek
relief from Hive.blog. If you do not agree with this Section 20, please
...
names, logos, trade secrets or patents, you and Hive.blog: (a) waive your
right to have any and all disputes or Claims arising from this Agreement or
Hive.blog (collectively, “Disputes”) resolved in a court; and (b) waive
your right to a jury trial. Instead, you and Hive.blog will arbitrate
...
that any dispute is personal to you and Hive.blog and that any such dispute
...
of another individual or group of individuals. Further, you and Hive.blog
...
provided by sending an email to legal@hive.blog. Your notice must include:
...
of the us receiving the notice, either you or Hive.blog may, as appropriate
...
This Agreement and your access to and use of the Service and the Hive.blog
...
your license to access and use of the Service, which includes, hive.blog, and
...
this edition available as an archive on hive.blog. By continuing to use the
Services after a change to this agreement, you agree to those changes.

## 25. Contact Information

Notices to Hive.blog. should be directed to legal@hive.blog.
