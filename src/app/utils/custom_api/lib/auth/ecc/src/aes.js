...
function crypt(private_key, public_key, nonce, message, checksum) {
    ...
    var ebuf = new _bytebuffer2.default(
    ...
    var cbuf = _bytebuffer2.default.fromBinary(
...
function cryptoJsDecrypt(message, key, iv) {
    ...
    var decipher = _browserifyAes2.default.createDecipheriv(
        'aes-256-cbc',
        key,
        iv
    );
...
var toPrivateObj = function toPrivateObj(o) {
    return o
        ? o.d
            ? o
            : _key_private2.default.fromWif(o)
        : o /*null or undefined*/;
};
var toPublicObj = function toPublicObj(o) {
    return o
        ? o.Q
            ? o
            : _key_public2.default.fromString(o)
        : o /*null or undefined*/;
};
