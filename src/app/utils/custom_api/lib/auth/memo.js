...
function decode(private_key, memo) {
    ...
    _assert2.default.equal(
        typeof memo === 'undefined' ? 'undefined' : _typeof(memo),
        'string',
        'memo'
    );
    ...
    var mbuf = _bytebuffer2.default.fromBinary(
...
function encode(private_key, public_key, memo, testNonce) {
    ...
    var mbuf = new _bytebuffer2.default(
        _bytebuffer2.default.DEFAULT_CAPACITY,
        _bytebuffer2.default.LITTLE_ENDIAN
    );
    ...
    var _Aes$encrypt = _ecc.Aes.encrypt(
            private_key,
            public_key,
            memo,
            testNonce
