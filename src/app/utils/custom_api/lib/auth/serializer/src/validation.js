...
module.exports = _my = {
    ...
    whole_number: function whole_number(value) {
        ...
        if (/\./.test(value)) {
            throw new Error(
                'whole number required ' + field_name + ' ' + value
            );
        }
        return value;
    },
    ...
    require_test: function require_test(regex, value) {
        ...
        if (!regex.test(value)) {
            throw new Error(
                'unmatched ' + regex + ' ' + field_name + ' ' + value
            );
        }
        return value;
    },
    ...
    require_range: function require_range(min, max, value) {
        ...
        if (value < min || value > max) {
            throw new Error(
                'out of range ' + value + ' ' + field_name + ' ' + value
            );
        }
        return value;
    },
    ...
    get_instance: (get_instance = function get_instance(
        reserve_spaces,
        type,
        value,
        field_name
    ...
    require_relative_type: (require_relative_type = function require_relative_type(
        type,
        value,
        field_name
    ) {
    ...
    get_relative_instance: (get_relative_instance = function get_relative_instance(
        type,
        value,
        field_name
    ) {
    ...
    require_protocol_type: (require_protocol_type = function require_protocol_type(
        type,
        value,
        field_name
    ) {
    ...
    get_protocol_instance: (get_protocol_instance = function get_protocol_instance(
        type,
        value,
        field_name
    ) {
    ...
    get_protocol_type: (get_protocol_type = function get_protocol_type(
        value,
        field_name
    ) {
        if (is_empty(value)) {
    ...
    require_implementation_type: (require_implementation_type = function require_implementation_type(
        type,
        value,
        field_name
    ) {
    ...
    get_implementation_instance: (get_implementation_instance = function get_implementation_instance(
        type,
        value,
        field_name
    ) {
