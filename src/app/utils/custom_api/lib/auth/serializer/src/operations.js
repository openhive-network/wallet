...
var smt_generation_unit = new Serializer(
    'smt_generation_unit',
    ((_ref = {}),
    _defineProperty(_ref, hiveVar() + '_unit', map(string, uint16)),
    _defineProperty(_ref, 'token_unit', map(string, uint16)),
    _ref)
);
...
var comment_options = new Serializer(
    ...
    _defineProperty(_ref3, 'allow_votes', bool),
    _defineProperty(_ref3, 'allow_curation_rewards', bool),
    _defineProperty(
        _ref3,
        'extensions',
        set(static_variant([comment_payout_beneficiaries, allowed_vote_assets]))
    ),
    _ref3)
);
...
var escrow_transfer = new Serializer(
    ...
    _defineProperty(_ref4, hbdVar() + '_amount', asset),
    _defineProperty(_ref4, hiveVar() + '_amount', asset),
    _defineProperty(_ref4, 'escrow_id', uint32),
    _defineProperty(_ref4, 'agent', string),
    _defineProperty(_ref4, 'fee', asset),
    _defineProperty(_ref4, 'json_meta', string),
    _defineProperty(_ref4, 'ratification_deadline', time_point_sec),
    _defineProperty(_ref4, 'escrow_expiration', time_point_sec),
    _ref4)
);
...
var escrow_release = new Serializer(
    ...
    _defineProperty(_ref5, hbdVar() + '_amount', asset),
    _defineProperty(_ref5, hiveVar() + '_amount', asset),
    _ref5)
);
...
var cancel_transfer_from_savings = new Serializer(
...
var claim_reward_balance = new Serializer(
    'claim_reward_balance',
    ((_ref6 = {
        account: string,
    }),
    _defineProperty(_ref6, 'reward_' + hiveVar(), asset),
    _defineProperty(_ref6, 'reward_' + hbdVar(), asset),
    _defineProperty(_ref6, 'reward_vests', asset),
    _ref6)
);
...
var account_create_with_delegation = new Serializer(
...
var smt_setup = new Serializer(
    ...
    _defineProperty(_ref7, hiveVar() + '_units_min', int64),
    _defineProperty(_ref7, 'min_unit_ratio', uint32),
    _defineProperty(_ref7, 'max_unit_ratio', uint32),
    _defineProperty(_ref7, 'extensions', set(future_extensions)),
    _ref7)
);
...
var smt_setup_ico_tier = new Serializer(
    'smt_setup_ico_tier',
    ((_ref8 = {
        control_account: string,
        symbol: asset_symbol,
    }),
    _defineProperty(_ref8, hiveVar() + '_units_cap', int64),
    _defineProperty(
        _ref8,
        'generation_policy',
        static_variant([smt_capped_generation_policy])
    ),
    _defineProperty(_ref8, 'remove', bool),
    _defineProperty(_ref8, 'extensions', set(future_extensions)),
    _ref8)
);
...
var author_reward = new Serializer(
    'author_reward',
    ((_ref9 = {
        author: string,
        permlink: string,
    }),
    _defineProperty(_ref9, hbdVar() + '_payout', asset),
    _defineProperty(_ref9, hiveVar() + '_payout', asset),
    _defineProperty(_ref9, 'vesting_payout', asset),
    _ref9)
);
