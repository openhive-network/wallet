    ...
    var resultP = hiveBroadcast
        ...
        .then(function (transaction) {
            ...
            return _bluebird2.default.join(
                transaction,
                _auth2.default.signTransaction(transaction, privKeys)
            );
        })
        .spread(function (transaction, signedTransaction) {
            ...
            return _api2.default
                .broadcastTransactionSynchronousAsync(signedTransaction)
...
hiveBroadcast._prepareTransaction = function hiveBroadcast$_prepareTransaction(
    tx
) {
    ...
    return propertiesP.then(function (properties) {
        ...
        return hfVersion.then(function (HFV) {
            ...
            return _api2.default
                ...
                .then(function (block) {
                    var headBlockId = block
                        ? block.previous
                        : '0000000000000000000000000000000000000000';
                    return Object.assign(
                        {
                            ref_block_num: refBlockNum,
                            ref_block_prefix: new Buffer(
                                headBlockId,
                                'hex'
                            ).readUInt32LE(4),
                            expiration: new Date(
...
var updateOperations = function updateOperations() {
    ...
    operations.forEach(function (operation) {
        ...
        hiveBroadcast[operationName] = function hiveBroadcast$specializedSend(
            wif
        ) {
            for (
            ...
            return hiveBroadcast[operationName + 'With'](
                wif,
                options,
                callback
            );
