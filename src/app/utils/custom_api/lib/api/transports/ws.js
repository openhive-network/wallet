...
var WsTransport = (function (_Transport) {
    ...
    function WsTransport() {
        ...
        var _this = _possibleConstructorReturn(
            this,
            (WsTransport.__proto__ || Object.getPrototypeOf(WsTransport)).call(
                this,
                Object.assign({ id: 0 }, options)
            )
        );
    ...
    _createClass(WsTransport, [
        {
            ...
            value: function start() {
                ...
                this.startPromise = new _bluebird2.default(function (
                    resolve,
                    reject
                ) {
        ...
        },
        {
            ...
            value: function onError(error) {
                ...
                try {
                    for (
                        var _iterator = this._requests[Symbol.iterator](),
                            _step;
        ...
        },
        {
            ...
            value: function onClose() {
                ...
                try {
                    for (
                        var _iterator2 = this._requests[Symbol.iterator](),
                            _step2;
