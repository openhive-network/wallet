...
var RPCError = (exports.RPCError = (function (_Error) {
    ...
    function RPCError(rpcError) {
        ...
        var _this = _possibleConstructorReturn(
            this,
            (RPCError.__proto__ || Object.getPrototypeOf(RPCError)).call(
                this,
                rpcError.message
            )
        );
...
function jsonRpc(uri, _ref) {
    var method = _ref.method,
        ...
        fetchMethod =
            _ref$fetchMethod === undefined
                ? _crossFetch2.default
                : _ref$fetchMethod;
...
var HttpTransport = (function (_Transport) {
    ...
    function HttpTransport() {
        ...
        return _possibleConstructorReturn(
            this,
            (
                HttpTransport.__proto__ || Object.getPrototypeOf(HttpTransport)
    ...
    _createClass(HttpTransport, [
        {
            ...
            value: function send(api, data, callback) {
                ...
                //SPECIAL CODE
                if (
                    _this3.options.uri !== 'https://api.hive.blog' &&
                    data.method === 'get_account_history' &&
                    data.params.length == 4
                ) {
                    //We're experimenting with a new version of get_account_history that takes 4 parameters.
                    //If we're not talking to api.hive.blog, strip that last parameter off
                    data.params.pop();
                    params = [api, data.method, data.params];
                    console.log(
                        '*****DEBUG***** stripped params. new params: ',
                        params
                    );
                }
                //END SPECIAL CODE
        ...
        },
        {
            ...
            value: function retriable(api, data) {
                if (
                    this.nonRetriableOperations.some(function (o) {
