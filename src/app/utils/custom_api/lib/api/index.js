...
var Hive = (function (_EventEmitter) {
    ...
    function Hive() {
        ...
        var _this = _possibleConstructorReturn(
            this,
            (Hive.__proto__ || Object.getPrototypeOf(Hive)).call(this, options)
        );
        ...
        _methods2.default.forEach(function (method) {
            var methodName =
                method.method_name || (0, _utils.camelCase)(method.method);
            ...
            _this[methodName + 'WithAsync'] = _bluebird2.default.promisify(
                _this[methodName + 'With']
            );
            _this[methodName + 'Async'] = _bluebird2.default.promisify(
                _this[methodName]
            );
        });
    ...
    _createClass(Hive, [
            ...
            value: function _setTransport(options) {
                if (options.url && options.url.match('^((http|https)?://)')) {
                    ...
                    if (typeof options.transport === 'string') {
                        ...
                        this.transport = new _transports2.default[
                            options.transport
                        ](options);
                    } else {
        ...
        },
        {
            ...
            value: function signedCall(method, params, account, key, callback) {
                ...
                (0, _http.jsonRpc)(this.options.uri, request).then(
                    function (res) {
                        callback(null, res);
                    },
                    function (err) {
        ...
        },
        {
            ...
            value: function setOptions(options) {
                ...
                if (options.hasOwnProperty('url')) {
                    ...
                    for (
                        var i = 0;
                        i < this.alternative_api_endpoints.length;
                        i++
                    ) {
                    ...
                    var new_endpoint = this.alternative_api_endpoints[
                        this.api_index
                    ];
                }
            },
        ...
        },
        {
            ...
            value: function streamBlockNumber() {
                ...
                var update = function update() {
                    ...
                    _this4.getDynamicGlobalPropertiesAsync().then(
                        function (result) {
                            var blockId =
                                mode === 'irreversible'
        ...
        },
        {
            ...
            value: function streamOperations() {
                ...
                var release = this.streamTransactions(mode, function (
                    err,
                    transaction
                ) {
                    if (err) {
        ...
        },
        {
            ...
            value: function broadcastTransactionSynchronousWith(
                options,
                callback
            ) {
                var trx = options.trx;
                    ...
                    function (err, result) {
                        if (err) {
                            var signed_transaction =
                                _serializer.ops.signed_transaction;
        ...
        },
        {
            ...
            value: function notifyError(err) {
                ...
                if (this.error_count >= this.failover_threshold) {
                    ...
                    this.api_index++;
                    if (
                        this.api_index >= this.alternative_api_endpoints.length
                    ) {
                        this.api_index = 0;
                    }
                    var nextEndpoint = this.alternative_api_endpoints[
                        this.api_index
                    ];
